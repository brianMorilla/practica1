...
public class CTTCompaniesJobssPR1Test {
    ...
    public void initialState() {
        ...
        Assert.assertEquals(4, this.cttCompaniesJobs.numPendingRequests());
    }
    ...
    public void addRequestTest() throws DSException {
        ...
        Assert.assertEquals(5, cttCompaniesJobs.numPendingRequests());
    ...
    public void updateRequestTest() throws DSException {
        ...
        Assert.assertEquals(createLocalDate("12-11-2023"), request3.getJobOffer().getStartDate());
        Assert.assertEquals(createLocalDate("31-12-2023"), request3.getJobOffer().getEndDate());
        Assert.assertEquals(49, request3.getJobOffer().getWorkingDays());
    ...
    public void signUpJobOfferTest() throws DSException {
        ...
        Assert.assertThrows(WorkerNotFoundException.class, () ->
                cttCompaniesJobs.signUpJobOffer("workerIdXXX", "jobOfferIA1"));
    ...
    public void getPercentageRejectedRequestTest() throws DSException {
        ...
        Assert.assertEquals(5, cttCompaniesJobs.numTotalRequests(),0);

        Assert.assertEquals(0.2, cttCompaniesJobs.getPercentageRejectedRequests(),0);
        ...
        Assert.assertEquals(0, cttCompaniesJobs.numPendingRequests(),0);
        Assert.assertEquals(3, cttCompaniesJobs.numJobOffers(),0);
        Assert.assertEquals(2, cttCompaniesJobs.numRejectedRequests(),0);

        Assert.assertEquals(5, cttCompaniesJobs.numTotalRequests(),0);

        Assert.assertEquals(0.4, cttCompaniesJobs.getPercentageRejectedRequests(),0);
    ...
    @Test
    public void getMostActiveUserTest() throws DSException {
        ...
        Assert.assertEquals(88, mostActiveUser.getWorkingDays());
        ...
        JobOffer jobOffer2 = it.next();
        Assert.assertEquals("jobOfferIdA3", jobOffer2.getJobOfferId());
        Assert.assertEquals(49, jobOffer2.getWorkingDays());
